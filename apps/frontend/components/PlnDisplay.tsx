...
export function PlanDisplay({ plan, planId }: PlanDisplayProps) {
     ...
     return (
        <div className="w-full mt-5 font-sans">
            <div className="text-center  px-4">
                 <h2 className="text-3xl font-bold text-gray-900 dark:text-cyan-100">{plan.plan_title}</h2>
                 <div className="text-base mt-2 text-gray-900 dark:text-cyan-300  flex items-center justify-center gap-1">
